CREATE DATABASE  IF NOT EXISTS `table` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `table`;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 COMMENT='url_typw';
...
CREATE TABLE `url` (
  ...
  PRIMARY KEY (`idurl`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb3 COMMENT='URL links .';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-03-14 16:24:26
